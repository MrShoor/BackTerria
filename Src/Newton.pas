...
// NewtonSceneProxy           = ^Pointer;
 ...
 TNewtonApplyForceAndTorque                  = procedure (const body : NewtonBody; timestep : dFloat; threadIndex : Integer); cdecl;
...
*)
 ...
 function NewtonCreateHeightFieldCollision (const world : NewtonWorld; width : Integer; height : Integer; gridsDiagonals : Integer;
                                            const elevationMap : PdFloat; const attributeMap : PShortInt; horizontalScale : dFloat; shapeID : Integer) : NewtonCollision; cdecl; external NEWTON_API;
...
// procedure NewtonBodySetAutoactiveCallback (const body : NewtonBody; NewtonBodyActivationState callback);
 ...
 procedure NewtonBodySetForceAndTorqueCallback (const body : NewtonBody; callback : TNewtonApplyForceAndTorque); cdecl; external NEWTON_API;
